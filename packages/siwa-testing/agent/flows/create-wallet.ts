...
export async function createWalletFlow(): Promise<void> {
  ...
  console.log(chalk.green(`\u{1F4DD} IDENTITY.md updated (public data only \u{2014} no private key stored here)`));
}
